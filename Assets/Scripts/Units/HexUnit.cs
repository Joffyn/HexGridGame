...
public class HexUnit : MonoBehaviour
{
    ...
    public UnitLookingAt unitLookAt { get; private set; }
    #endregion

    public HexCell neighboringCell;
  ...
  // public HexCoordinates unitCoords = new HexCoordinates();
    ...
    public void SetDirection()
    {
        ...
        if (Orientation >= 230f && Orientation <= 310)
        {
            unitLookAt = UnitLookingAt.West;
        }
        if (Orientation >= 310 || Orientation <= 50f)
        {
            unitLookAt = UnitLookingAt.North;
        }

        if (Orientation >= 50f && Orientation <= 130f)
        {
            unitLookAt = UnitLookingAt.East;

        }
        if (Orientation >= 130f && Orientation <= 230f)
        {
            unitLookAt = UnitLookingAt.South;
        }
